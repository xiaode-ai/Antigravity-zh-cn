...
try {
  ...
  const testCases = [
    ...
    // 新增测试用例
    { input: '30 secs ago', expected: '30秒前' },
    { input: '1 min ago', expected: '1分钟前' },
    { input: '27 mins ago', expected: '27分钟前' },
    { input: '35 mins ago', expected: '35分钟前' },
    { input: '55 mins ago', expected: '55分钟前' },
    { input: '1 hr ago', expected: '1小时前' },
    { input: '2 hrs ago', expected: '2小时前' },
    { input: '4 days ago', expected: '4天前' },
    { input: 'Chat Settings', expected: '对话设置' },
    { input: 'Conversation Settings', expected: '对话设置' },
    { input: 'Verbose Agent Chat', expected: '详细智能体对话' },
    { input: 'Display and preserve intermediate thinking steps.', expected: '显示并保留中间思考步骤。' },
    { input: 'Conversation Width', expected: '对话宽度' },
    { input: 'Configure the maximum width of the conversation panel.', expected: '配置对话面板的最大宽度。' },
    { input: 'Narrow', expected: '窄' },
    { input: 'Wide', expected: '宽' },
    { input: 'Automatic Check for Updates', expected: '自动检查更新' },
    { input: 'When enabled, you will be automatically prompted to restart the app when there is a new update available. When disabled, you can check for updates manually from the app menu.', expected: '启用后，当有新更新可用时，将自动提示您重启应用。禁用后，您可以从应用菜单中手动检查更新。' },
    { input: 'MCP Error', expected: 'MCP 错误' },
    { input: 'Welcome to Antigravity', expected: '欢迎使用 Antigravity' },
    { input: 'Welcome to', expected: '欢迎使用' },
    { input: 'Success, Continuing...', expected: '成功，正在继续...' },
    { input: 'Success, Continuing', expected: '成功，正在继续' },
    { input: 'Continuing...', expected: '正在继续...' },
    { input: 'Continuing', expected: '正在继续' },
    { input: 'Continue with Google', expected: '使用 Google 账号继续' },
    { input: 'Use Google Cloud project instead', expected: '改用 Google Cloud 项目' },
    { input: 'Awaiting Authentication...', expected: '等待身份验证...' },
    { input: 'Previous', expected: '上一步' },
    { input: 'Open IDE', expected: '打开 IDE' },
    { input: 'Open in Antigravity IDE', expected: '在 Antigravity IDE 中打开' },
    { input: 'Pin', expected: '固定' },
    { input: 'Copy Conversation Name', expected: '复制对话名称' },
    { input: 'Copy Conversation ID', expected: '复制对话 ID' },
    { input: 'Copy Workspace Name', expected: '复制工作区名称' },
    { input: 'Copy Project Name', expected: '复制项目名称' },
    { input: 'New Scheduled Task', expected: '新建计划任务' },
    { input: 'Name', expected: '名称' },
    { input: 'Enter scheduled task name...', expected: '输入计划任务名称...' },
    { input: 'Schedule', expected: '计划' },
    { input: 'Daily', expected: '每天' },
    { input: 'Weekly', expected: '每周' },
    { input: 'Monthly', expected: '每月' },
    { input: 'Hourly', expected: '每小时' },
    { input: 'Once', expected: '仅一次' },
    { input: 'around', expected: '大约在' },
    { input: 'Prompt', expected: '提示词' },
    { input: 'Enter a prompt for the agent to run...', expected: '输入让智能体运行的提示词...' },
    { input: 'All scheduled tasks run as Flash.', expected: '所有计划任务都将以 Flash 模型运行。' },
    { input: 'Add Scheduled Task', expected: '添加计划任务' },
