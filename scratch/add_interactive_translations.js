...
console.log(`Current translation count: ${translations.length}`);
...
newTranslations.forEach(item => {
  if (translations.some(t => t.old === item.old)) {
    console.log(`Skipping duplicate: ${item.old.substring(0, 30)}...`);
  } else {
...
if (addedCount > 0) {
  ...
  console.log(`Successfully merged ${addedCount} new translations!`);
} else {
