      ...
      if (endSearchIdx !== -1) {
        ...
        if (endLineIdx !== -1) {
          ...
          const replacementHeader = 
            ...
            '      if (normalized.startsWith(prefixRules[i].prefix)) {\\n' +
            ...
            '    if (normalized === \\\'View Diff\\\') return leadingSpaces + \\\'查看对比\\\' + trailingSpaces;\\n' +
            '    if (normalized === \\\'Viewing Diff\\\') return leadingSpaces + \\\'正在查看对比\\\' + trailingSpaces;\\n' +
