...
searchAround(mainContent, '?"Ran":', 'main.js');
searchAround(wbContent, '?"Ran":', 'workbench');

searchAround(mainContent, '?"Running":', 'main.js');
searchAround(wbContent, '?"Running":', 'workbench');
