...
console.log('label:"Browser" index:', mainContent.indexOf('label:"Browser"'));
console.log('label:"浏览器" index:', mainContent.indexOf('label:"浏览器"'));

console.log("=== vs/workbench/workbench.desktop.main.js ===");
console.log('label:"Browser" index:', wbContent.indexOf('label:"Browser"'));
console.log('label:"浏览器" index:', wbContent.indexOf('label:"浏览器"'));
