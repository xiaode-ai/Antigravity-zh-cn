...
if (entry) {
  ...
  if (match) {
    ...
    const newTranslations = {
      ...
      "Use when the user asks to search for terms, retrieve details, navigate hierarchies (parents, children, ancestors), look up properties and individuals, get autocomplete suggestions, or access ontology metadata and statistics.": "当用户要求搜索术语、获取详细信息、导航层级（父项、子项、祖先项）、查找属性和个体、获取自动补全建议，或访问本体元数据 and 统计信息时使用。",
